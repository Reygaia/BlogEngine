        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentCmt = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentNoti = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notification_AspNetUsers_UserEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PostID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CmtID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CommentID = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.ForeignKey(
                        name: "FK_CommentDetail_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentDetail_Comment_CommentID",
                        column: x => x.CommentID,
                        principalTable: "Comment",
                        principalColumn: "CommentID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentDetail_Post_PostID",
                        column: x => x.PostID,
                        principalTable: "Post",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentDetail_CommentID",
                table: "CommentDetail",
                column: "CommentID");

            migrationBuilder.CreateIndex(
                name: "IX_CommentDetail_PostID",
                table: "CommentDetail",
                column: "PostID");

            migrationBuilder.CreateIndex(
                name: "IX_CommentDetail_UserID",
                table: "CommentDetail",
                column: "UserID");
